...
public class SimpleRunner {
    ...
    public static void main(String[] args0) throws Exception {
        ...
        String trainingFilePath = "/home/kacper/dev/categorizer-lda/data/12/12Data.txt";
        String toInferencePath = "/home/kacper/dev/categorizer-lda/data/12/12EvalData.txt";
        String savePath = File.createTempFile(UUID.randomUUID().toString(),"").getAbsolutePath();
        System.out.print(savePath);


        modelTrainer = new ModelTrainer(trainingFilePath,50,12);
